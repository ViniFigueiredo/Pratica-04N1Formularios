...
<body>
    <div class="container">
        ...
        <form action="../pratica3arrays/questao15.php" method="POST">
        ...
        <a class="nav-link" href="../pratica3arrays/questao15.php">Ver Lista Completa de Registros</a>
    </div>
